  ...
  <div class="container-fluid ">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body ">
        ...
        <form action="<?php echo base_url().'c_nilai/nilai_pembimbing2/' ?>" method="post">
            ...
            <tr>
              ...
              <td><input class="form-control"
                ...
                <tr>
                  ...
                  <td>Motivasi</td>
                  <td><input class="form-control"
                    type="text" name="motivasi"  id="motivasi" placeholder="" value="" /></td>
                    <td align="center">10</td>
                    <td><input class="form-control"
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td><input class="form-control"
                          type="text" name="ps" id="ps" placeholder="" value="" /></td>
                          <td align="center">10</td>
                          <td><input class="form-control"
                          ...
                          <tr>
                            <td><input class="form-control"
                              type="text" name="asistensi" id="asistensi" placeholder="" value="" onfocus="bm" /></td>
                              <td align="center">10</td>
                              <td><input class="form-control"
                              ...
                              <tr>
                                <td><input class="form-control"
                                  type="text" name="bm" id="bm" placeholder="" value="" /></td>
                                  ...
                                  <tr>
                                    <td><input class="form-control"
                                      type="text" name="am" id="am" placeholder="" value="" /></td>
                                      <td align="center">5</td>
                                      <td><input class="form-control"
