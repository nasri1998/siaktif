          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
             ...
             <!--  <div class="card-body">
              ...
              <input type="text" name="nobp" value="<?php echo $mhs->nobp?>" />
          <input type="text" name="nip_pembimbing1" value="<?php echo $mhs->nip_pembimbing1?>" />
          <input type="text" name="nip_penguji1" value="<?php echo $mhs->nip_penguji1?>" />
          <input type="text" name="nip_penguji2" value="<?php echo $mhs->nip_penguji2?>" />
          <input type="text" name="nip_penguji3" value="<?php echo $mhs->nip_penguji3?>" />
